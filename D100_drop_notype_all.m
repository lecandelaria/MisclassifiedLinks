function D100_drop_notype_all(vils)
% % This code was taken from "Two-step estimation of network-formation models 
% with incomplete information" by Michael Leung.  Journal of Econometrics, 2015. 
%
...
for w=vils
	...
	for relationshipID=1:numRelationships
        ...
        %g = csvread(['directed_adjancency_matrices/',num2str(w),'-', curRelationship,'.csv']);
        g = csvread([num2str(w),'-', curRelationship,'.csv']);
        Nbefore = size(g,1) - 1;
